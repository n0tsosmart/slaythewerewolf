...
const CACHE_NAME = 'slay-werewolf-v1.1.0';
const ASSETS_TO_CACHE = [
    '/slaythewerewolf/',
    '/slaythewerewolf/index.html',
    '/slaythewerewolf/css/styles.css?v=1.1.0',
    '/slaythewerewolf/js/app.js?v=1.1.0',
    '/slaythewerewolf/js/translations.js?v=1.1.0',
