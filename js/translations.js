...
window.TRANSLATIONS = {
        ...
        es: {
                ...
                "privacy.peerJsTitle": "Modo Online: WebRTC (PeerJS)",
                "privacy.peerJsDesc": "Cuando usas el Modo Online, la aplicación utiliza PeerJS para conexiones peer-to-peer vía WebRTC. Esto requiere un servidor de señalización para establecer conexiones entre jugadores.",
                "privacy.peerJsData": "Datos intercambiados: Solo la información relacionada con el juego (asignación de roles, nombres de jugadores, códigos de sala) se transmite directamente entre los navegadores de los jugadores. El servidor de señalización solo facilita la conexión inicial y no almacena ni accede a los datos de tu juego.",
                "privacy.peerJsThirdParty": "PeerJS utiliza un servidor de señalización público por defecto. Si te preocupa la privacidad, puedes alojar tu propio servidor PeerJS.",
        ...
        it: {
                ...
                "privacy.peerJsDesc": "Quando utilizzi la Modalità Online, l'app utilizza PeerJS per connessioni peer-to-peer tramite WebRTC. Ciò richiede un server di segnalazione per stabilire connessioni tra i giocatori.",
                "privacy.peerJsData": "Dati scambiati: Solo le informazioni relative al gioco (assegnazione dei ruoli, nomi dei giocatori, codici stanza) vengono trasmesse direttamente tra i browser dei giocatori. Il server di segnalazione facilita solo la connessione iniziale e non archivia né accede ai tuoi dati di gioco.",
