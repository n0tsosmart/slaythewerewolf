/**
 * @fileoverview Italian translations for Slay the Werewolf
 * Version: 1.1.6
 */
export const it = {
    // Header Section
    ...
    // Offline
    "offline.indicator": "📴 Sei offline",
    "offline.onlineDisabled": "La modalità online richiede una connessione internet",
    ...
    "menu.rules": "📜 Regole di gioco",
    "rules.title": "Regole di Gioco",
    ...
    "tutorial.step1.title": "Benvenuto a Slay the Werewolf",
...
/**
 * Italian Mafia theme overrides
 */
export const itMafia = {
    "balance.wolves": "🔴 Favorisce la Mafia",
    "balance.village": "🔵 Favorisce i Cittadini",
