...
export const it = {
    ...
    "guide.step.closeEyes": "🌙 Notte {day} — Chiedi a tutti di chiudere gli occhi e rimanere in silenzio.",
    "guide.step.masons": "🤝 Chiama i Massoni — Aprono gli occhi, si riconoscono in silenzio, poi richiudono gli occhi.",
    "guide.step.bodyguard": "🛡️ Chiama la Guardia del Corpo — Indica il giocatore da proteggere stanotte, poi chiudi gli occhi.",
    "guide.step.seer": "👁️ Chiama il Veggente — Indica un giocatore da investigare. Annuisci per lupo, scuoti la testa per umano.",
    "guide.step.medium": "🔮 Chiama il Medium — Rivela se il linciato di ieri era un lupo mannaro (annuisci/scuoti).",
    "guide.step.owl": "🦉 Chiama il Gufo — Indica un giocatore da nominare per la discussione di domani.",
    "guide.step.mythomaniac": "🎭 Mitomane — Stanotte sceglie qualcuno da copiare. La risoluzione avviene all'alba.",
    "guide.step.wolves": "🐺 Chiama i Lupi Mannari — Aprono gli occhi, scelgono in silenzio una vittima, poi richiudono gli occhi.",
    "guide.step.hamster": "🐹 Ricorda: Il Criceto Mannaro è immune ai lupi ma muore istantaneamente se il Veggente lo indaga.",
    "guide.step.dawn": "☀️ Alba del Giorno {day} — Tutti aprono gli occhi. Annuncia drammaticamente le vittime della notte.",
    "guide.step.owlReveal": "📰 Rivela la nomina del Gufo — Questo giocatore è automaticamente un indiziato per il voto di oggi.",
    "guide.step.possessed": "👤 Ricorda: Un Indemoniato sta segretamente aiutando i lupi senza conoscerne l'identità.",
    "guide.step.dayDiscuss": "☀️ Giorno {day} Discussione — Lascia discutere il villaggio, poi raccogli i voti per i due indiziati.",
...
export const itMafia = {
    ...
    "guide.step.wolves": "🔫 Chiama la Mafia — Aprono gli occhi, scelgono in silenzio una vittima, poi richiudono gli occhi.",
    "guide.step.seer": "🔍 Chiama il Detective — Indica un giocatore da investigare. Annuisci per mafioso, scuoti la testa per cittadino.",
    "guide.step.bodyguard": "💉 Chiama il Dottore — Indica il giocatore da proteggere stanotte, poi chiudi gli occhi.",
    "guide.step.medium": "🧪 Chiama il Medico Legale — Rivela se l'arrestato di ieri era un mafioso (annuisci/scuoti).",
    "guide.step.owl": "📰 Chiama il Giornalista — Indica un giocatore da nominare per la discussione di domani.",
    "guide.step.owlReveal": "📰 Rivela la nomina del Giornalista — Questo giocatore è automaticamente un indiziato per il voto di oggi.",
    "guide.step.mythomaniac": "🎭 Impostore — Stanotte sceglie qualcuno da copiare. La risoluzione avviene all'alba.",
    "guide.step.possessed": "👤 Ricorda: Un Politico Corrotto sta segretamente aiutando la mafia senza conoscerne l'identità.",
    "guide.step.masons": "🤝 Chiama i Sindacalisti — Aprono gli occhi, si riconoscono in silenzio, poi richiudono gli occhi.",
    "guide.step.hamster": "🐀 Ricorda: Il Ratto è immune alla mafia ma muore istantaneamente se il Detective lo indaga.",
    ...
    "guide.step.dayDiscuss": "☀️ Giorno {day} Discussione — Lascia discutere la città, poi raccogli i voti per l'arresto.",
    "guide.step.dawn": "☀️ Mattina del Giorno {day} — Tutti aprono gli occhi. Annuncia drammaticamente le vittime della mafia.",
    ...
    "roles": {
        ...
        "werehamster": { "name": "Ratto", "teamLabel": "Solitario", "description": "Vuoi solo sopravvivere. Immune agli attacchi della mafia ma il Detective ti uccide se ti indaga. Vinci da solo se resti in vita fino alla fine." },
